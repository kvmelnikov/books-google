...
export function FormSearch() {
  ...
  return (
    <Form onSubmit={onFormSubmit} className={Style.container_form}>
      <Form.Group className={Style.form_group_input} controlId='formBasicEmail'>
        <Form.Control
          value={searchTerm}
          name='searchTerm'
      ...
      <Form.Group className={Style.form_group_select} controlId='formBasicEmail'>
